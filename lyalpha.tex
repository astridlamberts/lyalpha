...
% Assuming a uniform heating rate, (CITE ewald) showed that 



% In this case the IGM is heated up by pair of electrons/positrons through plasma instabilities
%  In this model, the TeV $\gamma$-rays from a subset of AGN 


The dominant fraction of the baryons in the universe are in a diffuse state
